...
letter_input_1 = input('Choose the 1st letter..."v" for vowels, "c" for consonants, "l" for a random letter ')
letter_input_2 = input('Choose the 2nd letter..."v" for vowels, "c" for consonants, "l" for a random letter ')
letter_input_3 = input('Choose the 3rd letter..."v" for vowels, "c" for consonants, "l" for a random letter ')
letter_input_4 = input('Choose the 4th letter..."v" for vowels, "c" for consonants, "l" for a random letter ')
letter_input_5 = input('Choose the 5th letter..."v" for vowels, "c" for consonants, "l" for a random letter ')
letter_input_6 = input('Choose the 6th letter..."v" for vowels, "c" for consonants, "l" for a random letter ')
